...
class MEISTER extends Page
{
	...
	protected function getViewData() {
		...
		$this->frage = $recordset->fetch_assoc();
		$recordset->free();
	}
...
EOT;
			...
			$frage = htmlspecialchars($this->frage['frage']);
			$antwort1 = htmlspecialchars($this->frage['antwort1']);
			$antwort2 = htmlspecialchars($this->frage['antwort2']);
			$antwort3 = htmlspecialchars($this->frage['antwort3']);
			echo <<<EOT
			<div>
				<h2>Frage:</h2>
				<p>$frage</p>
...
EOT;
			$_SESSION['richtigeAntwort'] = $this->frage['richtig'];
		}
